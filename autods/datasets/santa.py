...
class Santa(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/deepcontractor/is-that-santa-image-classification"
    remote_urls = {
        "is-that-santa-image-classification.zip": "kaggle datasets download -d deepcontractor/is-that-santa-image-classification",
    }
    name = "santa"
    file_hash_map = {'is-that-santa-image-classification.zip': '391c8548c10069feb7c5f070057d0762'}
    dataset_type = "image"
