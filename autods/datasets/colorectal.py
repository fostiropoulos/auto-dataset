...
class Colorectal(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/kmader/colorectal-histology-mnist"
    remote_urls = {
        "colorectal-histology-mnist.zip": "kaggle datasets download -d kmader/colorectal-histology-mnist",
    }
    name = "colorectal"
    dataset_type = "image"
    default_task_name ="none"
    file_hash_map = {'colorectal-histology-mnist.zip': 'e03501016bd54719567dfb954fe982fe'}
    ...
    def _make_metadata(self, raw_data_dir: Path):
        images = list(raw_data_dir.rglob("Kather_texture_2016_image_tiles_5000/*/*.tif"))
        # train test split
