...
class Rice(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/muratkokludataset/rice-image-dataset"
    remote_urls = {
        "rice-image-dataset.zip": "kaggle datasets download -d muratkokludataset/rice-image-dataset",
    }
    name = "rice"
    file_hash_map = {'rice-image-dataset.zip': '8a27da04489cd6ee5945e2590705e6d1'}
    dataset_type = "image"
