...
class Art(Dataset):
    metadata_url = "https://github.com/cs-chan/ArtGAN/tree/master/WikiArt%20Dataset"
    remote_urls = {
        "wikiart-gangogh-creating-art-gan.zip": "kaggle datasets download -d ipythonx/wikiart-gangogh-creating-art-gan",
    }
    name = "art"
    file_hash_map = {'wikiart-gangogh-creating-art-gan.zip': '99a59ce827edc95dd08701c85b294b4a'}
    ...
    def _make_metadata(self, raw_data_dir: Path):
        ...
        for split in ["train", "val"]:
            ...
            for idx in indices:
                path = images[idx]
                label = path.parent.as_posix().split('/')[-1]
