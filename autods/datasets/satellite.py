...
class Satellite(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/sandeshbhat/satellite-images-to-predict-povertyafrica"
    remote_urls = {
        "satellite-images-to-predict-povertyafrica.zip": "kaggle datasets download -d sandeshbhat/satellite-images-to-predict-povertyafrica",
    }
    name = "satellite"
    file_hash_map = {'satellite-images-to-predict-povertyafrica.zip': '85fe68393807cc7161d77ad4460e1615'}
    ...
    def _make_metadata(self, raw_data_dir: Path):
        images = list(raw_data_dir.rglob("images/*.png"))
        # train test split
        ...
        for split in ["train", "val"]:
            ...
            for idx in indices:
                path = images[idx]
                label = path.parent.parent.name.split('_')[0]
