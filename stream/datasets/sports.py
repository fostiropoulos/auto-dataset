...
class Sports(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/gpiosenka/sports-classification"
    remote_urls = {
        "sports-classification.zip": "kaggle datasets download -d gpiosenka/sports-classification",
    }
    name = "sports"
    file_hash_map = {'sports-classification.zip': 'f34a0d36da174b64922ba1cb7ca4b0d9'}
    dataset_type = "image"
    ...
    def _make_metadata(self, raw_data_dir: Path):
        train_images = list(raw_data_dir.rglob("train/*/*.jpg")) + list(raw_data_dir.rglob("valid/*/*.jpg"))
