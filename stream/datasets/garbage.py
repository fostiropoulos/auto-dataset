...
class Garbage(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/mostafaabla/garbage-classification"
    remote_urls = {
        "garbage-classification.zip": "kaggle datasets download -d mostafaabla/garbage-classification",
    }
    name = "garbage"
    file_hash_map = {'garbage-classification.zip': 'fc3d182eda9e3c64175f87251f17a24b'}
    dataset_type = "image"
