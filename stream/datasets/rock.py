...
class Rock(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/salmaneunus/rock-classification"
    remote_urls = {
        "rock-classification.zip": "kaggle datasets download -d salmaneunus/rock-classification",
    }
    name = "rock"
    file_hash_map = {'rock-classification.zip': '95dbfd2b23a2ed0160ef14fb1b6da212'}
    dataset_type = "image"
