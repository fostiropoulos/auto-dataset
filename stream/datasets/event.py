...
class Event(Dataset):
    metadata_url = "http://vision.stanford.edu/lijiali/event_dataset/"
    remote_urls = {
        "event_dataset.rar": "http://vision.stanford.edu/lijiali/event_dataset/event_dataset.rar",
    }
    name = "event"
    file_hash_map = {'event_dataset.rar': '22a1d43f12eebfa809b5425b706addbf'}
    dataset_type = "image"
