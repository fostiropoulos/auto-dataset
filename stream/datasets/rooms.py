...
class Rooms(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/robinreni/house-rooms-image-dataset"
    remote_urls = {
        "house-rooms-image-dataset.zip": "kaggle datasets download -d robinreni/house-rooms-image-dataset",
    }
    name = "rooms"
    file_hash_map = {'house-rooms-image-dataset.zip': '1831d1dc66e5947a817e97686fc5cefe'}
    dataset_type = "image"
