...
class Weather(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/pratik2901/multiclass-weather-dataset"
    remote_urls = {
        "multiclass-weather-dataset.zip": "kaggle datasets download -d pratik2901/multiclass-weather-dataset",
    }
    name = "weather"
    file_hash_map = {'multiclass-weather-dataset.zip': '26bea3212ab7f151f6bd95549896a114'}
    dataset_type = "image"
