...
class Simpsons(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/alexattia/the-simpsons-characters-dataset"
    remote_urls = {
        "the-simpsons-characters-dataset.zip": "kaggle datasets download -d alexattia/the-simpsons-characters-dataset",
    }
    file_hash_map = {'the-simpsons-characters-dataset.zip': 'c97abe815f7639d7e001339bb590ec3b'}
    name = "simpsons"
    dataset_type = "image"
    ...
    def _make_metadata(self, raw_data_dir: Path):
        images = list(raw_data_dir.rglob("simpsons_dataset/*/*.jpg"))
        # train test split
