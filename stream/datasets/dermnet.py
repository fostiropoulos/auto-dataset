...
class Dermnet(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/shubhamgoel27/dermnet"
    remote_urls = {
        "dermnet.zip": "kaggle datasets download -d shubhamgoel27/dermnet",
    }
    name = "dermnet"
    file_hash_map = {'dermnet.zip': '11b6e77e0dc360a2dda34909056992ef'}
    dataset_type = "image"
