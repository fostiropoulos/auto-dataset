...
class Asl(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/grassknoted/asl-alphabet"
    remote_urls = {
        "asl-alphabet.zip": "kaggle datasets download -d grassknoted/asl-alphabet",
    }
    name = "asl"
    file_hash_map = {'asl-alphabet.zip': '9a0a397aef38a4a36209c5e1c4d1d837'}
    dataset_type = "image"
    ...
    def _make_metadata(self, raw_data_dir: Path):
        images = list(raw_data_dir.rglob("asl_alphabet_train/*/*.jpg"))
        # train test split
