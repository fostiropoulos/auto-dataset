...
class Manga(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/mertkkl/manga-facial-expressions"
    remote_urls = {
        "manga-facial-expressions.zip": "kaggle datasets download -d mertkkl/manga-facial-expressions",
    }
    name = "manga"
    file_hash_map = {'manga-facial-expressions.zip': '9b0573cca52633bafbdb8b1ee4993000'}
    dataset_type = "image"
