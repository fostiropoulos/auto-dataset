...
class Concrete(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/arnavr10880/concrete-crack-images-for-classification"
    remote_urls = {
        "concrete-crack-images-for-classification.zip": "kaggle datasets download -d arnavr10880/concrete-crack-images-for-classification",
    }
    name = "concrete"
    file_hash_map = {'concrete-crack-images-for-classification.zip': 'ed44e4c92b5280d9b8642c70a5748cad'}
    dataset_type = "image"
