...
class Pokemon(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/lantian773030/pokemonclassification"
    remote_urls = {
        "pokemonclassification.zip": "kaggle datasets download -d lantian773030/pokemonclassification",
    }
    name = "pokemon"
    file_hash_map = {'pokemonclassification.zip': '6798da4770ba1184f977fa0874ef2740'}
    dataset_type = "image"
