...
class Minerals(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/youcefattallah97/minerals-identification-classification"
    remote_urls = {
        "minerals-identification-classification.zip": "kaggle datasets download -d youcefattallah97/minerals-identification-classification",
    }
    name = "minerals"
    file_hash_map = {'minerals-identification-classification.zip': '0c8bb312bf6b418787f75b4db1001ce6'}
    dataset_type = "image"
