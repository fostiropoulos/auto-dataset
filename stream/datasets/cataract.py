...
class Cataract(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/jr2ngb/cataractdataset"
    remote_urls = {
        "cataractdataset.zip": "kaggle datasets download -d jr2ngb/cataractdataset",
    }
    file_hash_map = {'cataractdataset.zip': '2b8a95b5a4d9f9b332204e48ccf333f8'}
    name = "cataract"
    dataset_type = "image"
