...
class Face(Dataset):
    metadata_url = "https://www.kaggle.com/datasets/shiekhburhan/face-mask-dataset"
    remote_urls = {
        "face-mask-dataset.zip": "kaggle datasets download -d shiekhburhan/face-mask-dataset",
    }
    file_hash_map = {'face-mask-dataset.zip': '4fbaa2b83665fff17fe410591bc8b6f3'}
    name = "face"
    dataset_type = "image"
